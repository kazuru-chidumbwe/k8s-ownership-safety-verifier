...
git checkout v0.1.8   # package cite pin
...
Methodology / package cite: **`v0.1.8`** (denser-poll archive `20260815T023902Z` + `--poll-interval` from `v0.1.7`; primary matrix stamp from `v0.1.6`); see [`docs/TAGS.md`](docs/TAGS.md). The old essay tag `blog-kosv01-2026-07` was deleted (superseded pre-fault-reach snapshot). Add the journal / Zenodo citation when published.
