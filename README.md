...
Tag: v0.1.21
https://doi.org/10.5281/zenodo.22081925
```

Methodology / package cite: **`v0.1.21`** (same matrices and fault-reach as `v0.1.19`; Zenodo https://doi.org/10.5281/zenodo.22081925). See [`docs/TAGS.md`](docs/TAGS.md). The old essay tag `blog-kosv01-2026-07` was deleted (superseded pre-fault-reach snapshot).
