...
git checkout v0.1.9   # package cite pin
...
Methodology / package cite: **`v0.1.9`** (primary matrix archive `20260814T083135Z` + denser-poll `20260815T023902Z` + seeded arms); see [`docs/TAGS.md`](docs/TAGS.md). The old essay tag `blog-kosv01-2026-07` was deleted (superseded pre-fault-reach snapshot). Add the journal / Zenodo citation when published.
