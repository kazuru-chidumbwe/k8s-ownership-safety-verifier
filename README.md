...
Tag: v0.1.19
https://doi.org/10.5281/zenodo.22081581
```

Methodology / package cite: **`v0.1.19`** (v0.1.18 matrices + version-matched fault-reach on Kind v1.34.0 / v1.35.0; primary `20260814T083135Z` + denser-poll + seeded + StatefulSet + v1.35 confirmation); see [`docs/TAGS.md`](docs/TAGS.md) and [`CITATION.cff`](CITATION.cff). Zenodo https://doi.org/10.5281/zenodo.22081581. The old essay tag `blog-kosv01-2026-07` was deleted (superseded pre-fault-reach snapshot).
