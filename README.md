...
git checkout v0.1.19   # package cite pin
...
Tag: v0.1.19
https://doi.org/10.5281/zenodo.21950898
```

Methodology / package cite: **`v0.1.19`** (v0.1.18 matrices + version-matched fault-reach on Kind v1.34.0 / v1.35.0; primary `20260814T083135Z` + denser-poll + seeded + StatefulSet + v1.35 confirmation); see [`docs/TAGS.md`](docs/TAGS.md) and [`CITATION.cff`](CITATION.cff). Zenodo concept https://doi.org/10.5281/zenodo.21950898 (version DOI filled after mint). The old essay tag `blog-kosv01-2026-07` was deleted (superseded pre-fault-reach snapshot).
...
| [`docs/evidence/fault-reach-20260824-v134/`](docs/evidence/fault-reach-20260824-v134/) | Primary-image fault reach: `kindest/node:v1.34.0` |
| [`docs/evidence/fault-reach-20260824-v135/`](docs/evidence/fault-reach-20260824-v135/) | Confirmation-image fault reach: `kindest/node:v1.35.0` |
| [`docs/evidence/fault-reach-2026-07-27/`](docs/evidence/fault-reach-2026-07-27/) | Historical eth0 netem path-reach capture |
