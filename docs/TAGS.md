...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.1.16`](https://github.com/kazuru-chidumbwe/k8s-ownership-safety-verifier/releases/tag/v0.1.16) | `15efc98` | **Current cite** — PeerJ CS / Zenodo archive (`10.5281/zenodo.21950899`); same tree as `v0.1.15` |
...
**Removed (2026-08-04):** `blog-kosv01-2026-07` — superseded pre-fault-reach / pre-O2-fix snapshot. Do not cite. Use **`v0.1.16`**.
...
- Do not move a published SemVer tag; cut `v0.1.17` / `v0.2.0` instead.
